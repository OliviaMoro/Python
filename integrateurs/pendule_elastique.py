...
def plotPotentiel():
    ...
    plt.plotSurf(r,theta,V,'r (m)',r'$\theta$(radians)','','Energie potentielle')
    plt.plotContour(r,theta,V,'r (m)',r'$\theta$(radians)','Energie potentielle')
...
def testEnergie(r,vr,theta,vtheta):
    E = []
    T = []
    V = []
...
if __name__ == "__main__":
    ...
    #plt.plotGraph(t,r,"t (s)","r (m)","r(t)")
    #plt.plotGraph(t,theta,"t (s)",r'$\theta$ (radians)',r'$\theta(t)$')
    #plt.plotGraph(theta,r,r'$\theta$ (radians)',"r (m)",r'$r(\theta)$')
    x,y = getCartesianArray(r,theta)
    print("min x : ",np.min(x))
    print("max x : ",np.max(x))
    print("min y : ",np.min(y))
    print("max y : ",np.max(y))
    #plt.plotGraph(x,-y,"x (m)","y (m)","y(x)")
    
    #Vérification de l'énergie
    #T,V,E = testEnergie(r,vr,theta,vtheta)
